...
function child_enqueue_styles()
{
	...
	if (is_user_logged_in() && is_page('my-account')) {
		...
		wp_enqueue_script('astra-child-theme-my-account-page-css', get_stylesheet_directory_uri() . '/assets/js/myaccount.js', array('jquery'), CHILD_THEME_ASTRA_CHILD_VERSION, 'all');
	}
